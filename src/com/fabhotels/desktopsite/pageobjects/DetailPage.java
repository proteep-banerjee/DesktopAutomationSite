...
public class DetailPage {
	...
	public static final By hotelDescription_WE = By.xpath("//div[@class='why-this-hotel-wrap why-this-hotel-inner-less']/p");
	...
	public String getLabelText_rackPriceNearBy_Lbl(int i){
		if(!driver.findElement(By.xpath(exploreMorePropertiesCard_WE+"["+i+"]"+rackPriceNearBy_Lbl)).isDisplayed()){
		 return "ABCDEF";
		}
		else return generic.getText(exploreMorePropertiesCard_WE+"["+i+"]"+rackPriceNearBy_Lbl);
	}
