...
import Fab_Application.Controller.SRPTestCases.ValidateSorting.SRP_ValidateSorting_Manager;
...
//            enabled = true)
//    public void highToLowSortTest(String cityName, String checkInMonth, String checkInDate){
//        try{
//            logger = extent.startTest("High to low Sorting");
//            driver = DriverHelper.initiateMwebBrowserInstance(browserName,
//                    firstServer, Constants.mobileWebCapabilities(DeviceConfiguration.DeviceName));
...
//    }
//
//    @Test(enabled = true, dependsOnMethods = {"highToLowSortTest"})
//    public void lowToHighSortTest() throws IOException {
//        try{
