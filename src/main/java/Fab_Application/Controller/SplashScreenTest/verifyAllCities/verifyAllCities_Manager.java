package Fab_Application.Controller.SplashScreenTest.verifyAllCities;
...
import static Fab_Application.Controller.POM.SplashScreen.SplashScreen_POM.getMoreCities;
import static Fab_Application.Controller.POM.SplashScreen.SplashScreen_POM.moreCitesOption;


public class verifyAllCities_Manager {
    ...
    public void verifyOurLocationsOption(WebDriver driver, ExtentTest logger) throws IOException, InterruptedException {
        ...
        List<WebElement> List = SplashScreen_POM.getAllourLocations(driver,logger);
