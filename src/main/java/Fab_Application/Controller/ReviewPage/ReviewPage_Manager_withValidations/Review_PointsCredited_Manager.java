...
public class Review_PointsCredited_Manager {
	...
	public void VerifyPointsCredited(WebDriver driver, String userType, ExtentTest logger) throws IOException, InterruptedException {
