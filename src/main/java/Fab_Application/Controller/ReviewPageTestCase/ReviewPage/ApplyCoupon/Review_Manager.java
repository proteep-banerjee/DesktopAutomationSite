package Fab_Application.Controller.ReviewPageTestCase.ReviewPage.ApplyCoupon;
...
public class Review_Manager {
	...
	public void Validate_TC(WebDriver driver, String couponCode,int discountPercentage, ExtentTest logger) throws IOException, InterruptedException {
